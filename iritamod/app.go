...
import (
	...
	blist "github.com/bianjieai/iritamod/modules/blist"
...
func NewIritaApp(
	...
	app.mm.SetOrderBeginBlockers(
		...
		tibchost.ModuleName, wevmtypes.ModuleName, evmtypes.ModuleName, blisttypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(
		...
		// evm
		evmtypes.ModuleName, feemarkettypes.ModuleName, wevmtypes.ModuleName, blisttypes.ModuleName,
	)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(blisttypes.ModuleName)
	return paramsKeeper
}
